	...
	public static void main(String[] args) {
		...
		///////////// CARNIVOROS
				...
				if(entrada.equalsIgnoreCase("le�o") || entrada.equalsIgnoreCase("leao")) {
					...
					"\n| Amea�ado de Ex: " + lion.isExtincao() + "\n| Habitat: " + lion.getHabitat() + "\n| Comida: " +
					lion.getComida());
					...
					"\n| Amea�ado de Ex: " + snake.isExtincao() + "\n| Habitat: " + snake.getHabitat() + "\n| Comida: " +
					snake.getComida());
